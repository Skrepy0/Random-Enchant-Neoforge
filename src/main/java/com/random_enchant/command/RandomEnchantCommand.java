...
public class RandomEnchantCommand {
    private static boolean boolConfig(CommandContext<CommandSourceStack> context, boolean preStatus, String configId) {
        ...
        if (preStatus == enabled) {
            Component message = Component.literal("§a[" + configId + "]§r")
                                        .append(translatable("command.random_enchant.config.unchanged"));
            RandomEnchant.LOGGER.info(message.getString());
            context.getSource().sendSuccess(() -> message, false);
            return false;
        }
        Component message = Component.literal("§a[" + configId + "]§r")
                                    .append(translatable("command.random_enchant.config.changed"))
    ...
    private static void showValue(CommandContext<CommandSourceStack> context, String configId, String value) {
        Component message =
                Component.literal(translatable("command.random_enchant.value").getString().formatted(configId) + value);
        context.getSource().sendSuccess(() -> message, false);
    }

    private static String getBoolString(boolean value) { return value ? "§atrue§r" : "§cfalse§r"; }
                ...
                Commands.literal("random_enchant")
                        ...
                        .then(Commands.literal("config")
                                      ...
                                      .then(Commands.literal("doRandomEnchant")
                                                    .executes(context -> {
                                                        showValue(context, "doRandomEnchant",
                                                                  getBoolString(Config.randomEnchant()));
                                                        return 1;
                                                    })
                                      ...
                                      .then(Commands.literal("alwaysEnchantable")
                                                    .executes(context -> {
                                                        showValue(context, "alwaysEnchantable",
                                                                  getBoolString(Config.isAlwaysEnchantable()));
                                                        return 1;
                                                    })
                                                    .then(Commands.argument("enabled", BoolArgumentType.bool())
                                                                  .executes(context -> {
                                                                      boolean preStatus = Config.isAlwaysEnchantable();
                                                                      if (boolConfig(context, preStatus,
                                                                                     "isAlwaysEnchantable")) {
                                      ...
                                      .then(Commands.literal("infinityUndyingTotem")
                                                    .executes(context -> {
                                                        showValue(context, "infinityUndyingTotem",
                                                                  getBoolString(Config.infinityUndyingTotem()));
                                                        return 1;
                                                    })
                                                    .then(Commands.argument("enabled", BoolArgumentType.bool())
                                                                  .executes(context -> {
                                      ...
                                      .then(Commands.literal("explodeDestroyBlock")
                                                    .executes(context -> {
                                                        showValue(context, "explodeDestroyBlock",
                                                                  getBoolString(Config.getExplodeDestroyBlock()));
                                                        return 1;
                                                    })
                                                    .then(Commands.argument("enabled", BoolArgumentType.bool())
                                                                  .executes(context -> {
                                      ...
                                      .then(Commands.literal("infinityBlock")
                                                    .executes(context -> {
                                                        showValue(context, "infinityBlock",
                                                                  getBoolString(Config.infinityBlock()));
                                                        return 1;
                                                    })
                                                    .then(Commands.argument("enabled", BoolArgumentType.bool())
                                                                  .executes(context -> {
                                      ...
                                      .then(Commands.literal("infinityTnt")
                                                    .executes(context -> {
                                                        showValue(context, "infinityTnt",
                                                                  getBoolString(Config.infinityTnt()));
                                                        return 1;
                                                    })
                                                    .then(Commands.argument("enabled", BoolArgumentType.bool())
                                                                  .executes(context -> {
                                      ...
                                      .then(Commands.literal("infinityFood")
                                                    .executes(context -> {
                                                        showValue(context, "infinityFood",
                                                                  getBoolString(Config.infinityFood()));
                                                        return 1;
                                                    })
                                                    .then(Commands.argument("enabled", BoolArgumentType.bool())
                                                                  .executes(context -> {
                                      ...
                                      .then(Commands.literal("infinityThrowableItem")
                                                    .executes(context -> {
                                                        showValue(context, "infinityThrowableItem",
                                                                  getBoolString(Config.infinityThrowableItem()));
                                                        return 1;
                                                    })
                                                    .then(Commands.argument("enabled", BoolArgumentType.bool())
                                                                  .executes(context -> {
                                      ...
                                      .then(Commands.literal("isEnchantedBlockGetatable")
                                                    .executes(context -> {
                                                        showValue(context, "isEnchantedBlockGetatable",
                                                                  getBoolString(Config.isEnchantedBlockGetatable()));
                                                        return 1;
                                                    })
                                                    .then(Commands.argument("enabled", BoolArgumentType.bool())
                                                                  .executes(context -> {
                                                                      ...
                                                                      if (boolConfig(context, preStatus,
                                                                                     "isEnchantedBlockGetatable")) {
                                                                          Config.setIsEnchantedBlockGetatable(
                                                                                  !preStatus);
                                                                      }
                                                                      return 1;
                                                                  })))
                                      .then(Commands.literal("infinityPotion")
                                                    .executes(context -> {
                                                        showValue(context, "infinityPotion",
                                                                  getBoolString(Config.infinityPotion()));
                                                        return 1;
                                                    })
                                                    .then(Commands.argument("enabled", BoolArgumentType.bool())
                                                                  .executes(context -> {
                                      ...
                                      .then(Commands.literal("infinityDispenser")
                                                    .executes(context -> {
                                                        showValue(context, "infinityDispenser",
                                                                  getBoolString(Config.infinityDispenser()));
                                                        return 1;
                                                    })
                                                    .then(Commands.argument("enabled", BoolArgumentType.bool())
                                                                  .executes(context -> {
                                      ...
                                      .then(Commands.literal("infinityFood").executes(context -> {
                                          showValue(context, "infinityFood", getBoolString(Config.infinityFood()));
                                          return 1;
                                      }))
                                      .then(Commands.literal("bedrockViolable")
                                                    .executes(context -> {
                                                        showValue(context, "bedrockViolable",
                                                                  getBoolString(Config.getBedrockViolable()));
                                                        return 1;
                                                    })
                                                    .then(Commands.argument("enabled", BoolArgumentType.bool())
                                                                  .executes(context -> {
                                      ...
                                      .then(Commands.literal("redirectTridentSetPointDistance")
                                                    .executes(context -> {
                                                        showValue(context, "redirectTridentSetPointDistance",
                                                                  "§b" + Config.getRedirectTridentSetPointDistance());
                                                        return 1;
                                                    })
                                      ...
                                      .then(Commands.literal("flyEnchantmentLiftHeightPerTick")
                                                    .executes(context -> {
                                                        showValue(context, "flyEnchantmentLiftHeightPerTick",
                                                                  "§b" + Config.getFlyEnchantmentLiftHeightPerTick());
                                                        return 1;
                                                    })
