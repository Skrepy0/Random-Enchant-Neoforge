...
public class Config {
    ...
    public static ModConfigSpec.BooleanValue randomEnchant =
    ...
    public static ModConfigSpec.BooleanValue isEnchantedBlockGetatable =
            BUILDER.comment("玩家使用带有§b[精准采集]§r附魔的工具破坏被附魔的方块时，可以掉落该带有附魔的方块")
                    .define("isEnchantedBlockGetatable", true);
    public static ModConfigSpec.IntValue redirectTridentSetPointDistance =
            BUILDER.comment("含有§6[重定向]§r附魔的三叉戟在使用时右键，落点与玩家的最大距离")
    ...
    public static ModConfigSpec.DoubleValue flyEnchantmentLiftHeightPerTick =
            BUILDER.comment("玩家使用附魔有§d[Fly]§r的鞘翅，并按下跳远键时，每tick提升的高度")
