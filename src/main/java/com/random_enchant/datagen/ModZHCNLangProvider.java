...
//        add("random_enchant.configuration.isAlwaysEnchantable.comment","§l所有物品§r可以通过§a铁砧§r附魔");
        add("random_enchant.configuration.infinityUndyingTotem","§d[无限]§r附魔对不死图腾的兼容");
        add("random_enchant.configuration.infinityBlock","§d[无限]§r附魔对可放置方块的兼容");
        add("random_enchant.configuration.infinityTnt","§d[无限]§r附魔对TNT的兼容");
        add("random_enchant.configuration.infinityPotion","§d[无限]§r附魔对药水的兼容");
